...
(0, mocha_1.describe)("Login default user to get validation token.", () => {
    (0, mocha_1.it)("Create new user", async () => {
        const user = headersTools_1.HeadersTools.defaultUser;
        ...
        headersTools_1.HeadersTools.userToken = res.body.token;
    });
});
